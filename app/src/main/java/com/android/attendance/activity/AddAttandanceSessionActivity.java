...
public class AddAttandanceSessionActivity<AddAttandanceActivity> extends Activity {
	...
	private String[] branchString = new String[] {"BBA", "BCS", "BSSE", "BS ENG"};
	private String[] yearString = new String[] {"1st","2nd","3rd", "Last"};
	...
	private String[] subjectFinal = new String[] {"AI","ML","HCI","C++","Java","Web"};
